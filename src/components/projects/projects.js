...
import projeto2 from '../../images/projects/crud-api.png';
...
const Projects = () => (
        ...
        <Row>
            ...
            <Card>
                ...
                <Row className ="center-align">
                    <a href="https://github.com/lucassilva996/CRUD-WebApi" target="_blank" rel="noreferrer"><img src={projeto2}  alt="linkedin" className="cicle responsive-img" width="850" height="850"/></a>
                <b><p>Descrição:</p></b>
