    ...
    <Row>
        ...
        <Col m={8} s={12}>
            ...
            <Experience title="Desenvolvedor Jr - Out/2020 a Atual"
                       ...
                       description = "&bull;	Atuação no Back-End (Outubro 2020-Junho 2021) realizando as seguintes atividades: Desenvolvimento de Web-Api's utilizando Asp.Net Core; Desenvolvimento de projetos de testes unitários utilizando MSUnit; Criação de Testes de Performance com JMeter; Criação de Collections de Testes de Integração utilizando o Postman; Desenvolvimento de Class Libraries para suprimir algumas necessidades dos projetos; Criação e configuração de esteira CI/CD para Build e Deploy das aplicações; Versionamento de Código com GitLab; Visualização de logs para massa de dados via Splunk; Acompanhamento de desempenho das APIS via AppDynamics e Grafana; Utilização do OpenShift (PAAS) para gerenciamento de apis e serviços legados; &bull;	Atuação no Front-End (Junho 2021 - Atual) realizando as seguintes atividades: Mapeamento das telas do projeto legado para modernização; Criação dos Wireframes do novo front-end no FIGMA.; Desenvolvimento das novas páginas e componentes com HTML, CSS e JavaScript utilizando ReactJS; Criação das rotas utilizando o React Routes; Consumo das Apis do Back-End .NET utilizando o AXIOS"
